...
#indexReference = 10
referenceImage = sitk.ReadImage(dataPath + referenceImageFilename)    #Es una Reference image no un Reference slice image
print('Reference image: {0}. Voxel size: {1}. Image Size: {2}'.format(referenceImageFilename, referenceImage.GetSpacing(), referenceImage.GetSize()))
