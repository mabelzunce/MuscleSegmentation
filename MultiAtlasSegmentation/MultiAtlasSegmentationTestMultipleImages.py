...
#targetPath = 'D:\\Martin\\Segmentation\\RawImagesForTesting\\'
...
###################### OUTPUT #####################
# Output path:
baseOutputPath = 'D:\\MuscleSegmentationEvaluation\\SegmentationWithPython\\' + libraryVersion + '\\Nonrigid{0}plusplus_N{1}_MaxProb_Mask\\'.format(segType, numberOfSelectedAtlases)
